...
# no specific CPPFLAGS by default, but let the users define them
CPPFLAGS +=

@DO_EXPORT RUNCC RUNLD CORECXXFLAGS LDLIBS PICLDFLAGS VERBOSE SOCKETENGINE CORELDFLAGS CPPFLAGS
