 ...
 *
 *   Copyright (C) 2017, 2020-2024 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	ModuleNoNotice()
		: Module(VENDOR, "Adds channel mode T (nonotice) which allows channels to block messages sent with the /NOTICE command.")
	...
	{
		if ((details.type == MessageType::NOTICE) && (target.type == MessageTarget::TYPE_CHANNEL) && (user->IsLocal()))
		{
