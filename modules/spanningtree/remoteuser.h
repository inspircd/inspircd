 ...
 *
 *   Copyright (C) 2019, 2021 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	...
	void WriteRemoteNumeric(Numeric::Numeric& numeric) override;
	void WriteRemoteNumeric(std::vector<Numeric::Numeric>& numeric) override;
