 ...
 *   Copyright (C) 2013, 2017-2018, 2020-2023, 2025 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	using TreeSocketSet = std::set<TreeSocket*>;
	using TimeoutList = std::map<TreeSocket*, std::pair<std::string, unsigned int>>;
