 ...
 *   Copyright (C) 2017, 2019-2021, 2023-2024 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	ModuleStripColor()
		: Module(VENDOR, "Adds channel mode S (stripcolor) which allows channels to strip IRC formatting codes from messages.")
