 ...
 *   Copyright (C) 2018-2023, 2025 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	ModuleBlockAmsg()
		: Module(VENDOR, "Blocks mass messages sent using the /AME and /AMSG commands that exist in clients such as mIRC and HexChat.")
