 ...
 *
 *   Copyright (C) 2017-2022, 2024 Sadie Powell <sadie@sadiepowell.dev>
...
CmdResult CommandModules::Handle(User* user, const Params& parameters)
{
	...
	bool for_us = (parameters.empty() || insp::casemapped_equals(parameters[0], ServerInstance->Config->ServerName));
