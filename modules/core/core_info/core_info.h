...
private:
	...
	using NumericList = std::vector<Numeric::Numeric>;
	using NumericMap = insp::flat_map<std::shared_ptr<ConnectClass>, NumericList>;
	NumericMap cachednumerics;

	/** The tokens which were generated by the last update. */
	using TokenMap = insp::flat_map<std::shared_ptr<ConnectClass>, ISupport::TokenMap>;
