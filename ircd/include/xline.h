...
class CoreExport XLine : public classbase {
  ...
  public:
     ...
     */
    XLine(time_t s_time, unsigned long d, const std::string& src,
...
class CoreExport KLine : public XLine {
  public:
     ...
     */
    KLine(time_t s_time, unsigned long d, const std::string& src,
          const std::string& re, const std::string& ident, const std::string& host)
...
class CoreExport GLine : public XLine {
  public:
     ...
     * @param host Host to match
     */
    GLine(time_t s_time, unsigned long d, const std::string& src,
          const std::string& re, const std::string& ident, const std::string& host)
...
class CoreExport ELine : public XLine {
  public:
     ...
     * @param host Host to match
     */
    ELine(time_t s_time, unsigned long d, const std::string& src,
          const std::string& re, const std::string& ident, const std::string& host)
...
class CoreExport ZLine : public XLine {
  public:
     ...
     */
    ZLine(time_t s_time, unsigned long d, const std::string& src,
          const std::string& re, const std::string& ip)
...
class CoreExport QLine : public XLine {
  public:
     ...
     */
    QLine(time_t s_time, unsigned long d, const std::string& src,
          const std::string& re, const std::string& nickname)
...
class CoreExport XLineFactory {
  ...
  public:
     ...
     */
    virtual XLine* Generate(time_t set_time, unsigned long duration,
...
class CoreExport XLineManager {
  ...
  public:
     ...
     */
    bool DelLine(const char* hostmask, const std::string& type, std::string& reason,
                 User* user, bool simulate = false);
    ...
    DEPRECATED_METHOD(void InvokeStats(const std::string& type,
    ...
    void ExpireRemovedConfigLines(const std::string& type,
