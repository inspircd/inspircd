...
class CoreExport CommandParser {
  public:
    typedef TR1NS::unordered_map<std::string, Command*, irc::insensitive, irc::StrHashComp>
    CommandMap;
  ...
  private:
     ...
     */
    void ProcessCommand(LocalUser* user, std::string& command,
  ...
  public:
     ...
     */
    CmdResult CallHandler(const std::string& commandname,
                          const CommandBase::Params& parameters, User* user, Command** cmd = NULL);
     ...
     */
    static bool LoopCall(User* user, Command* handler,
                         const CommandBase::Params& parameters, unsigned int splithere, int extra = -1,
                         bool usemax = true);
     ...
     */
    static void TranslateSingleParam(TranslateType to, const std::string& item,
                                     std::string& dest, CommandBase* custom_translator = NULL,
     ...
     */
    static std::string TranslateUIDs(const std::vector<TranslateType>& to,
                                     const CommandBase::Params& source, bool prefix_final = false,
