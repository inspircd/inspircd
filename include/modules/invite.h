...
class Invite::APIBase : public DataProvider {
  public:
     ...
     */
    bool IsInvited(LocalUser* user, Channel* chan) {
        return (Find(user, chan) != NULL);
    }
 ...
 */
class Invite::Invite : public insp::intrusive_list_node<Invite, LocalUser>,
    public insp::intrusive_list_node<Invite, Channel> {
  public:
