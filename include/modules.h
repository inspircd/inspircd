...
enum Implementation
{
	...
	I_OnPreRehash, I_OnModuleRehash, I_OnSendWhoLine, I_OnChangeIdent, I_OnStatsLine,
	I_OnSetClientIP,
	I_END
};
...
class CoreExport Module : public classbase, public usecountbase
{
 public:
	...
	/** Called whenever a result from a /STATS query is about to be returned
	 * @param user The user who did the /STATS query
	 * @param symbol The stats symbol which was queried
	 * @param line The raw line to be sent to the user, if empty this line won't be sent
	 * @param core_generated True if the replies were generated by the core, false if a module handled the request
	 */
	virtual void OnStatsLine(User* user, char symbol, std::string& line, bool core_generated);
