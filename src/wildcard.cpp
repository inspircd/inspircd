 ...
 *
 *   Copyright (C) 2013, 2017, 2021-2022 Sadie Powell <sadie@sadiepowell.dev>
...
bool InspIRCd::Match(const std::string& str, const std::string& mask, const insp::casemap* map)
{
	if (!map)
...
bool InspIRCd::Match(const char* str, const char* mask, const insp::casemap* map)
{
	if (!map)
		map = national_case_insensitive_map;
...
bool InspIRCd::MatchCIDR(const std::string& str, const std::string& mask, const insp::casemap* map)
{
...
bool InspIRCd::MatchCIDR(const char* str, const char* mask, const insp::casemap* map)
{
	if (irc::sockets::MatchCIDR(str, mask, true))
		return true;
