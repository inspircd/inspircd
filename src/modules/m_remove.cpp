...
class ModuleRemove : public Module
{
 ...
 public:
	...
	{
		return Version("Provides a /remove and /fpart commands, this is mostly an alternative to /kick, except makes users appear to have parted the channel", VF_OPTCOMMON | VF_VENDOR);
	}
};
