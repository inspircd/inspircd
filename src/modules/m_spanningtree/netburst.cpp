...
{
	SnomaskManager::Write(SNO_LOCAL, Utils->Creator->link, "Bursting to \2%s\2 (Authentication: %s%s).",
		s->GetName().c_str(),
	...
	SnomaskManager::Write(SNO_LOCAL, Utils->Creator->link, "Finished bursting to \2"+ s->GetName()+"\2.");
}
