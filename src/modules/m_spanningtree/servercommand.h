...
class ServerCommand : public CommandBase {
  public:
    ServerCommand(Module* Creator, const std::string& Name,
                  unsigned int MinPara = 0, unsigned int MaxPara = 0);
...
class UserOnlyServerCommand : public ServerCommand {
  public:
    UserOnlyServerCommand(Module* Creator, const std::string& Name,
                          unsigned int MinPara = 0, unsigned int MaxPara = 0)
...
class ServerOnlyServerCommand : public ServerCommand {
  public:
    ServerOnlyServerCommand(Module* Creator, const std::string& Name,
                            unsigned int MinPara = 0, unsigned int MaxPara = 0)
        : ServerCommand(Creator, Name, MinPara, MaxPara) { }
